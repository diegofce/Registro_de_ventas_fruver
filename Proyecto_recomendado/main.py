...
from Proyecto_recomendado.operaciones import agregar_producto, calcular_total
from Proyecto_recomendado.exepciones import manejo_de_errores
from Proyecto_recomendado.productos import productos, historial_ventas
